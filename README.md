...
<br/>
`FKEY ENUM`         Optional: Default=FKEYS_INTERNAL  Enumeration: 'FKEYS_INTERNAL', 'FKEYS_EXTERNAL', 'FKEYS_COMMENTED', 'FKEYS_NONE'  DEFAULT=INTERNAL
<br/>
`TRIG ENUM`         Optional: Default=NO_TRIGGERS     Enumeration: 'INCLUDE_TRIGGERS', 'NO_TRIGGERS'  DEFAULT=NO_TRIGGERS
<br/><br/>
